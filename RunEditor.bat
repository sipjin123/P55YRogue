...
set unrealPath="O:\UnrealEngine\UE_5.5\Engine\Binaries\Win64\UnrealEditor.exe"

set myProject="O:\Projects\UE5_ProjY55 5.2 5.4\P5YY.uproject"

set map=/Game/Maps/TestMap_Combat
set server_map=/Game/Maps/TestMap_Combat
